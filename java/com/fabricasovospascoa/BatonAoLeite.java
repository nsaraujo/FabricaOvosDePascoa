 ...
 * @author 55649
 */
public class BatonAoLeite implements Produto{
    ...
    public BatonAoLeite(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Garoto - BATON AO LEITE \n");
