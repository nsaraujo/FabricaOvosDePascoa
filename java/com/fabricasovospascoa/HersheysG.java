 ...
 * @author 55649
 */
public class HersheysG implements Produto{
    ...
    public HersheysG(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
   ...
   @Override
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Hershey's - HERSHEYS G \n");
