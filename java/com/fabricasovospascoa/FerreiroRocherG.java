 ...
 * @author 55649
 */
public class FerreiroRocherG implements Produto{
    ...
    public FerreiroRocherG(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Ferreiro - FERREIRO ROCHER G \n");
