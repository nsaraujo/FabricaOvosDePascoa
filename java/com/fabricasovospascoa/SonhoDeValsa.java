 ...
 * @author 55649
 */
public class SonhoDeValsa implements Produto {
    ...
    public SonhoDeValsa(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Lacta - SONHO DE VALSA \n");
