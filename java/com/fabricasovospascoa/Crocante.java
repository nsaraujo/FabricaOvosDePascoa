 ...
 * @author 55649
 */
public class Crocante implements Produto {
    ...
    public Crocante(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void exibir_info_produto() {
        System.out.println("Crocante ");
    }

    @Override
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Garoto - CROCANTE \n");
