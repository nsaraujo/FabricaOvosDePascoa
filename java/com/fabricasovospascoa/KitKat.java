 ...
 * @author 55649
 */
public class KitKat implements Produto {
    ...
    public KitKat(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Nestlé - KitKat \n");
