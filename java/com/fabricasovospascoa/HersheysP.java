 ...
 * @author 55649
 */
public class HersheysP implements Produto{
    ...
    public HersheysP(String carboidratos, String açucares, String gorduras, String peso, double valor, int codigo) {
    ...
    public void cod_produto(int i) {
        if (this.codigo == i) {
            System.out.println("Chocolate - Hershey's - HERSHEYS P \n");
